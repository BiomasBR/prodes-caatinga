...
# PRODES 2025 - CLASSIFICAÇÃO LTAE - BANDAS + NDII
...
saveRDS(cubo_treino, file.path(dir_rds, "cubo_treino_rm5_ndii_ltae_2025.rds"))
cubo_treino <- readRDS(file.path(dir_rds, "cubo_treino_rm5_ndii_ltae_2025.rds"))
# ==================================================================================
...
# )
# 
# saveRDS(amostras, file.path(dir_rds, "amostras_rm5_ndii.rds"))
# Recarregar em nova sessão
amostras <- readRDS(
  "Prodes2025/Arquivos_rds/amostras_rm5_ndii.rds")
...
saveRDS(tuned_rm5, "Prodes2025/Arquivos_rds/tuned_ltae_rm5_ndii.rds")
tuned_rm5 <- readRDS("Prodes2025/Arquivos_rds/tuned_ltae_rm5_ndii.rds")
...
saveRDS(modelo_ltae , file.path(dir_model, "modelo_ltae_rm5_ndii.rds"))
modelo_ltae2<-readRDS("Prodes2025/modelos/modelo_ltae_rm5_ndii.rds")
...
tempos_df <- tibble(
  etapa = c("Tuning", "Treinamento", "Classificação"),
