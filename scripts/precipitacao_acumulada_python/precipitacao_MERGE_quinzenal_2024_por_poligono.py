"""
Precipitacao acumulada quinzenal MERGE/CPTEC-INPE - 2024
por poligono do shapefile Tiles_BDC_Caatinga_Clusters_v2.zip

Saidas:
  1) precipitacao_MERGE_quinzenal_2024_long.csv
  2) precipitacao_MERGE_quinzenal_2024_wide.csv
  3) precipitacao_MERGE_quinzenal_2024.xlsx
...
Depois, execute no notebook:
  %run precipitacao_MERGE_quinzenal_2024_por_poligono.py
"""
...
# Diretorios locais
PASTA_DADOS = Path("MERGE_2024_daily")
PASTA_TEMP = Path("MERGE_2024_quinzenas_temp")
PASTA_SAIDA = Path("resultados_MERGE_2024")

# Se True, os 366 GRIB2 ficam em disco para permitir reexecucao sem novo download.
# O conjunto de 2024 ocupa aproximadamente algumas centenas de MB.
...
def main():
    ...
    print("=" * 78)
    print("MERGE/CPTEC-INPE - PRECIPITACAO ACUMULADA QUINZENAL - 2024")
    print("=" * 78)
    ...
    csv_long = PASTA_SAIDA / "precipitacao_MERGE_quinzenal_2024_long.csv"
    csv_wide = PASTA_SAIDA / "precipitacao_MERGE_quinzenal_2024_wide.csv"
    xlsx = PASTA_SAIDA / "precipitacao_MERGE_quinzenal_2024.xlsx"
