...
saveRDS(cubo_treino, file.path(dir_rds, "cubo_treino_teste_SVM.rds"))
cubo_treino <- readRDS(file.path(dir_rds, "cubo_treino_teste_SVM.rds"))
...
saveRDS(amostras, file.path(dir_rds, "amostras_cubo_teste_SVM.rds"))

# Recarregar em nova sessão

amostras <- readRDS(file.path(dir_rds,"amostras_cubo_teste_SVM.rds"))
...
saveRDS(modelo_svm, file.path(dir_model, "modelo_SVM.rds"))
modelo_svm <- readRDS(file.path(dir_model, "modelo_SVM.rds"))
